...
myBottomSheet(BuildContext context){
  return showModalBottomSheet<dynamic> (
    ...
    child:  myStyle('Add New Member', 16, Color(0xffF8F8F8), FontWeight.w700),
    ),
    myStyle("Make your team good with us. invite your team members. to get goingMake your team good with us. invite your team\nmembers. to get going", 12, Color(0xffE9E9EB), FontWeight.w400),
    SizedBox(height: 10,),
    Align(
    alignment: Alignment.topLeft,
    child:    myStyle("Team Members", 16, Color(0xffF8F8F8), FontWeight.w400),
    ),
    SizedBox(height: 8,),
    TextField(
